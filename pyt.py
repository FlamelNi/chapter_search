...
=======
        2: "Suppose that you intercept 5.0 ' 10$3 of the energy radiated by a hot sphere that has a radius of 0.020 m, an emissivity of 0.80, and a surface temperature of 500 K. How much energy do you intercept in 2.0 min?",
>>>>>>> c041e54fb776647a95d62d1442e93d16e1ab38cf
        ...
        4: "A horizontal force of magnitude 35.0 N pushes a block of mass 4.00 kg across a floor wherewhere the coefficientof kinetic friction is 0.600. (a) How much work is done by that applied force on the block floor system when the block slides through a displacement of 3.00m across the floor? (b) During that displacement, the thermal energy of the block increases by 40.0 J. What is the increase in thermal energy of the floor? (c) What is the increase in the kinetic energy of the block?",
        ...
        7: "The velocity of a 3.00 kg particle is given by  (8.00t + 3.00t^2 ) m/s, with time t in seconds. At the instant the net force on the particle has a magnitude of 35.0 N, what are the direction (relative to the positive direction of the x axis) of (a) the net force and (b) the particle’s direction of travel?"
